...
loc.obs = cbind(kenya.geo$LONGNUM, kenya.geo$LATNUM)
...
save(myData, u.sim, kenya.geo, file="simulation/myDataOriginal.RData")
...
saveRDS(res_stan, file = "STAN_new_original.RDS")
...
save(res_stan, data.stan, uSample, thetaSample, sdSpatialSample, rangeSample, sdNuggetSample, etaSample, file="STAN_new_original.RData")
...
saveRDS(res_stan, file = "STAN_old_original.RDS")
...
save(start_all, start_INLA, end_INLA, start_newSTAN, end_newSTAN, start_sampNewSTAN, end_sampNewSTAN, start_oldSTAN, end_oldSTAN, start_sampOldSTAN, end_sampOldSTAN, end_all, file="time_initialOriginal.RData")
#Save results from analysis with old STAN file
save(res_stan, data.stan, uSample, thetaSample, sdSpatialSample, rangeSample, sdNuggetSample, etaSample, file="STAN_old_original.RData")
