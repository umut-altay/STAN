...
load("simulation_grid/myDataOriginalGrid.RData") 
...
save(myData, u.sim, kenya.geo, file="simulation_grid/myDataJitteredGrid.RData")
...
save(res_stan, data.stan, uSample, thetaSample, sdSpatialSample, rangeSample, sdNuggetSample, etaSample, file="simulation_grid/STAN_old_jitteredGrid.RData")
