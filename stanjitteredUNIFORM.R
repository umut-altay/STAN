...
load("simulation_uniform/myDataOriginalUniform.RData") 
...
save(myData, u.sim, kenya.geo, file="simulation_uniform/myDataJitteredUniform.RData")
...
save(res.inla, res.inla.hyper, stk.e, stk.pred, stk.full, file="simulation_uniform/INLA_jitteredUniform.RData")
...
saveRDS(res_stan, file = "simulation_uniform/STAN_new_jitteredUniform.RDS")
...
save(res_stan, data.stan, uSample, thetaSample, sdSpatialSample, rangeSample, sdNuggetSample, etaSample, file="simulation_uniform/STAN_new_jitteredUniform.RData")
...
saveRDS(res_stan, file = "simulation_uniform/STAN_old_jitteredUniform.RDS")
...
save(res_stan, data.stan, uSample, thetaSample, sdSpatialSample, rangeSample, sdNuggetSample, etaSample, file="simulation_uniform/STAN_old_jitteredUniform.RData")
